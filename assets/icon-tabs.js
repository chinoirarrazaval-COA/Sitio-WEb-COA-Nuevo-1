class IconTabs extends HTMLElement {
  constructor() {
    ...
    this.tabsTitle = this.querySelectorAll(".tabs-container__popout-title")
    this.designMode()
    ...
    this.tabsIcons.forEach((icon, idx) => {
      ...
      icon.addEventListener("click", () => {
        ...
        const sectionTitle = this.tabsTitle[idx]
  ...
  hideAllTitle() {
    this.tabsTitle.forEach(title => title.classList.remove('active'))
  }
